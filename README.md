 Qurban sons Issuing and Treasury: An Embedded Finance  application

This  a basic web application with embedded finance features built on QurbanSons’s Issuing and Treasury APIs.
